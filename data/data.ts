export const BaseInfo = {
  ...
  export const education = [
    {
      ...
      attendedYear: "2024 - Present",
      description: "To further develop my knowledge and skills in software engineering, I enrolled in this program with a focus on advanced topics like Data Security and process mining.",
      link: "https://dtu.dk/"
    },
    {
      id:2,
  ...
  export const experience = [
    {
      id: 1,
      image: "/images/experience/parkshare-logo.png",
      company:"ParkShare",
      title: "Frontend Developer",
      summary:
        "As a frontend developer in ParkShare, I gained handson experince in building reusable componets using React.js and tailwind. I also collaborated with UI/UX designers to make the website user-friendly.",
      date: "January 2022 - June 2022",
      link: "https://parkshare.dk/",
    }
  ];
